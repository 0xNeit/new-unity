...
import {
  ...
  getVTokenContract,
  getUaiVaultContract,
  getUrtConverterProxyContract,
  getUcoreVaultProxyContract,
} from './getters';
 ...
 */
export const useUaiVaultContract = () => {
  const { signer } = useAuth();
  return useMemo(() => getUaiVaultContract(signer || undefined), [signer]);
};
 ...
 * @deprecated Use useGetUniqueContract hook instead
 */
export const useUcoreVaultProxyContract = () => {
  const { signer } = useAuth();
  return useMemo(() => getUcoreVaultProxyContract(signer || undefined), [signer]);
};
 ...
 * @deprecated Use useGetUniqueContract hook instead
 */
export const useUrtConverterProxyContract = () => {
  const { signer } = useAuth();
  return useMemo(() => getUrtConverterProxyContract(signer || undefined), [signer]);
};
