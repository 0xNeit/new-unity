    ...
    markets = Object.keys(VBEP_TOKENS).reduce<Market[]>((acc: Market[], marketAddress: string) => {
      ...
      if (activeMarket) {
        const formattedActiveMarket = {
          ...
          borrowVenusApy: new BigNumber(activeMarket.borrowUcoreApy),
          borrowVenusApr: new BigNumber(activeMarket.borrowUcoreApr),
          ...
          supplyVenusApr: new BigNumber(activeMarket.supplyUcoreApr),
          supplyVenusApy: new BigNumber(activeMarket.supplyUcoreApy),
